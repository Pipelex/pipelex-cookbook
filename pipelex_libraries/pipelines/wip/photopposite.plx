domain = "wip_domain"
description = "Analyze a photo's most important feature and generate an image depicting its opposite"

[concept.FeatureAnalysis]
description = "Analysis of a photo's visual content and key features"

[concept.FeatureAnalysis.structure]
dominant_feature = { type = "text", description = "The most important or dominant feature in the image", required = true }
visual_elements = { type = "text", description = "Description of key visual elements present", required = true }
...
description = "Conceptual description of the opposite of a photo's most important feature"

[concept.OppositeConcept.structure]
opposite_feature = { type = "text", description = "The conceptual opposite of the dominant feature", required = true }
visual_description = { type = "text", description = "Visual description of what the opposite would look like", required = true }
reasoning = "Explanation of why this is considered the opposite"
key_differences = "Key differences from the original"

[concept.ImagePrompt]
description = "Detailed prompt for generating an image"

[pipe.gen_photopposite]
type = "PipeSequence"
description = "Analyze photo and generate its opposite"
