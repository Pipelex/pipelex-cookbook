...
- You should ALWAYS RUN the terminal command `pipelex validate all` when you are writing a `.toml` file. It will ensure the pipe is runnable. If not, iterate.
...
type = "PipeCondition"
definition = "A conditonal pipe to decide whether..."
