...
`github.com/Pipelex/pipelex-cookbook/blog_article_generator@v0.18.0` · [bundle.mthds](bundle.mthds)
...
> Run github.com/Pipelex/pipelex-cookbook/blog_article_generator@v0.18.0 to write a long, casual blog article about capybaras for kids
...
START=$(curl -s https://api.pipelex.com/v1/start \
  ...
  -d '{"method_ref": "github.com/Pipelex/pipelex-cookbook/blog_article_generator@v0.18.0", "inputs": {"user_prompt": {"text": "Write a fun and engaging blog article", "topic": "Capybara", "audience": "Kids", "tone": "Casual", "length": "Long"}}}')
...
In a project you already have, ask your agent for `/pipelex-integrate github.com/Pipelex/pipelex-cookbook/blog_article_generator@v0.18.0`: it generates the result's types and writes one typed call.

## Make it an app

```bash
npm create @pipelex/method-app@latest blog-app -- --method github.com/Pipelex/pipelex-cookbook/blog_article_generator@v0.18.0
...
```bash
curl -sLo inputs.json https://raw.githubusercontent.com/Pipelex/pipelex-cookbook/v0.18.0/methods/blog_article_generator/inputs.json
pipelex run method github.com/Pipelex/pipelex-cookbook/blog_article_generator@v0.18.0 --inputs inputs.json
```
