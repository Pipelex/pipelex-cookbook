...
`github.com/Pipelex/pipelex-cookbook/extract_generic@v0.17.0` · [bundle.mthds](bundle.mthds) · [sample article](https://raw.githubusercontent.com/Pipelex/pipelex-cookbook/main/assets/extract_generic/fintech_article_with_text_in_images.pdf)
...
> Run github.com/Pipelex/pipelex-cookbook/extract_generic@v0.17.0 on https://raw.githubusercontent.com/Pipelex/pipelex-cookbook/main/assets/extract_generic/fintech_article_with_text_in_images.pdf
...
const result = await client.startAndWaitForResult({
  method_ref: "github.com/Pipelex/pipelex-cookbook/extract_generic@v0.17.0",
  inputs: {
    document: {
...
START=$(curl -s https://api.pipelex.com/v1/start \
  ...
  -d '{"method_ref": "github.com/Pipelex/pipelex-cookbook/extract_generic@v0.17.0", "inputs": {"document": {"url": "https://raw.githubusercontent.com/Pipelex/pipelex-cookbook/main/assets/extract_generic/fintech_article_with_text_in_images.pdf"}}}')
...
In a project you already have, ask your agent for `/pipelex-integrate github.com/Pipelex/pipelex-cookbook/extract_generic@v0.17.0`: it generates the result's types and writes one typed call.

## Make it an app

```bash
npm create @pipelex/method-app@latest extract-app -- --method github.com/Pipelex/pipelex-cookbook/extract_generic@v0.17.0
...
Ask your agent: "Copy github.com/Pipelex/pipelex-cookbook/extract_generic@v0.17.0 into ./extract, turn the tables it finds into CSV alongside the Markdown, prove it on the sample, and save it to my Pipelex account." From then on every door above takes your method's id (`mt_…`) in place of the address, and your chatbot lists it among your methods.
...
```bash
curl -sLo inputs.json https://raw.githubusercontent.com/Pipelex/pipelex-cookbook/v0.17.0/methods/extract_generic/inputs.json
pipelex run method github.com/Pipelex/pipelex-cookbook/extract_generic@v0.17.0 --inputs inputs.json
```
