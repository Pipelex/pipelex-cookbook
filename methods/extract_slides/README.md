...
`github.com/Pipelex/pipelex-cookbook/extract_slides@v0.17.0` · [bundle.mthds](bundle.mthds) · [sample deck](https://raw.githubusercontent.com/Pipelex/pipelex-cookbook/main/assets/presentations/CatOps.pdf)
...
> Run github.com/Pipelex/pipelex-cookbook/extract_slides@v0.17.0 on https://raw.githubusercontent.com/Pipelex/pipelex-cookbook/main/assets/presentations/CatOps.pdf
...
const result = await client.startAndWaitForResult({
  method_ref: "github.com/Pipelex/pipelex-cookbook/extract_slides@v0.17.0",
  inputs: {
    document: {
...
START=$(curl -s https://api.pipelex.com/v1/start \
  ...
  -d '{"method_ref": "github.com/Pipelex/pipelex-cookbook/extract_slides@v0.17.0", "inputs": {"document": {"url": "https://raw.githubusercontent.com/Pipelex/pipelex-cookbook/main/assets/presentations/CatOps.pdf"}}}')
...
In a project you already have, ask your agent for `/pipelex-integrate github.com/Pipelex/pipelex-cookbook/extract_slides@v0.17.0`: it generates the result's types and writes one typed call.

## Make it an app

```bash
npm create @pipelex/method-app@latest slides-app -- --method github.com/Pipelex/pipelex-cookbook/extract_slides@v0.17.0
...
```bash
curl -sLo inputs.json https://raw.githubusercontent.com/Pipelex/pipelex-cookbook/v0.17.0/methods/extract_slides/inputs.json
pipelex run method github.com/Pipelex/pipelex-cookbook/extract_slides@v0.17.0 --inputs inputs.json
```
