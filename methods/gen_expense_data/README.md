...
`github.com/Pipelex/pipelex-cookbook/gen_expense_data@v0.18.0` · [bundle.mthds](bundle.mthds)
...
> Run github.com/Pipelex/pipelex-cookbook/gen_expense_data@v0.18.0 for two employees
...
START=$(curl -s https://api.pipelex.com/v1/start \
  ...
  -d '{"method_ref": "github.com/Pipelex/pipelex-cookbook/gen_expense_data@v0.18.0", "inputs": {"nb_employees": {"number": 2}}}')
...
In a project you already have, ask your agent for `/pipelex-integrate github.com/Pipelex/pipelex-cookbook/gen_expense_data@v0.18.0`: it generates the result's types and writes one typed call.

## Make it an app

```bash
npm create @pipelex/method-app@latest expense-data-app -- --method github.com/Pipelex/pipelex-cookbook/gen_expense_data@v0.18.0
...
```bash
curl -sLo inputs.json https://raw.githubusercontent.com/Pipelex/pipelex-cookbook/v0.18.0/methods/gen_expense_data/inputs.json
pipelex run method github.com/Pipelex/pipelex-cookbook/gen_expense_data@v0.18.0 --inputs inputs.json
```
