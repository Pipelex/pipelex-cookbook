...
class TestShape:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("date", "2022-03-29", "20220329"),
            ("date", "2022-03-29", "2022-W13-2"),
            ("date", "2022-03-29", "2022-02-30"),
            ("datetime", "2026-09-26T10:00:00Z", "2026-13-01T10:00:00"),
            ("datetime", "2026-09-26T10:00:00.250+02:00", "20260926T100000"),
            ("datetime", "2026-09-26T10:00:00", "2026-09-26"),
            ("integer", 21, 21.5),
            ("integer", 21, True),
            ("number", 560.0, "560"),
            ("number", 18, False),
