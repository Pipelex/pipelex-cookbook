...
```bash
pipelex run examples/b_basics/document_extract/extract_proof_of_purchase/bundle.plx -i examples/b_basics/document_extract/extract_proof_of_purchase/inputs.json
```
...
```bash
pipelex build runner examples/b_basics/document_extract/extract_proof_of_purchase/bundle.plx
```
