...
```bash
pipelex run examples/b_basics/document_extract/extract_proof_of_purchase/bundle.mthds -i examples/b_basics/document_extract/extract_proof_of_purchase/inputs.json -L examples/documents
```
