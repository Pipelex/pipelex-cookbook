...
```bash
pipelex run bundle examples/b_basics/document_extract/extract_proof_of_purchase/
```
...
```bash
pipelex build runner bundle examples/b_basics/document_extract/extract_proof_of_purchase/bundle.mthds
```
