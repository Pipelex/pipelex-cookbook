...
```bash
pipelex run bundle examples/b_basics/document_extract/extract_table/
```
...
```bash
pipelex build runner bundle examples/b_basics/document_extract/extract_table/bundle.mthds
```
