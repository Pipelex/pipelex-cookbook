...
```bash
pipelex run examples/b_basics/generate-visuals/gen_image/bundle.plx
```
...
```bash
pipelex build runner examples/b_basics/generate-visuals/gen_image/bundle.plx
```

This will create a new file `examples/b_basics/generate-visuals/gen_image/run_crazy_image_generation.py` and a `structures` directory containing the python structures.
